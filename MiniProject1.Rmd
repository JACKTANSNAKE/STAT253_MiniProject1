...
price ~ amenity_count
The coefficient of `amenity` in the LASSO model is 0.0184181137. Thus, as `amenity_count` increases by 1, `price` multiplies by $e^(0.0184181137). This is intuitive because as listings provide more amenities for guests hosts can increase the price. 
